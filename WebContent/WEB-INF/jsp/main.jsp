	...
	function addPanel(id,url,name){
    	...
    	if(exist){
    		...
    		$('#tt').tabs('add',{
    			id:id,
    			title: name,
    			content: '<div style="width:100%;height:100%;"><iframe class="page-iframe" src="${pageContext.request.contextPath}'+url+'" frameborder="no"   border="no" height="100%" width="100%" scrolling="auto"></iframe></div>',
    			closable: true
    		});
    	}
	}
           ...
           <div class="pf-logo"">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${pageContext.request.contextPath}/images/main/xlei.jpg" alt="">
                </div>
            ...
            <div id="pf-sider">
				...
				<ul class="sider-nav" id="sider-nav">
					<li><a href="javascript:;"> <span
							...
							class="sider-nav-title">医院挂号系统</span> <i
							class="iconfont">&#xe642;</i>
					</a>
            ...
            <div id="pf-page">
                <div class="easyui-tabs" id="tt" style="width:100%;height:100%;">
                  <div title="当前用户" id="user" style="padding:10px 5px 5px 10px;">
                    	<iframe class="page-iframe" src="${pageContext.request.contextPath}/oa/home" frameborder="no"   border="no" height="100%" width="100%" scrolling="auto"></iframe>
                  </div>
                </div>
            </div>
        </div>
